...
- Treat `wrappers-ts/SimpleExtension.gen.ts` and `wrappers-ts/WalletV5.gen.ts` as generated output. Prefer regenerating them from the contract ABI instead of hand-editing them when the ABI changes.
