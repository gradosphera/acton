...
"#,
        "integration/snapshots/test-runner/lib_api_wallet_mode_tests/lib_api_wallet_uses_local_treasury_when_broadcast_disabled.stdout.txt",
    );
}
...
"#,
    ...
    ProjectBuilder::new("s-lib-api-enable-broadcast-wallet-lookup")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_wallet_mode_tests/lib_api_enable_broadcast_wallet_lookup_requires_configured_wallet.stdout.txt",
        );
}
...
"#,
        "integration/snapshots/test-runner/lib_api_wallet_mode_tests/lib_api_disable_broadcast_restores_local_wallet_resolution.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/lib_api_wallet_mode_tests/lib_api_broadcast_toggle_roundtrip_updates_mode.stdout.txt",
    );
}
...
"#,
        "integration/snapshots/test-runner/lib_api_wallet_mode_tests/lib_api_local_wallet_names_map_to_distinct_treasuries.stdout.txt",
    );
}
