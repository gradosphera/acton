...
fn fmt_supports_mixed_hex_ton_and_plain_placeholders() {
    ProjectBuilder::new("t-lib-api-fmt-mixed-placeholders")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_fmt_env_tests/fmt_supports_mixed_hex_ton_and_plain_placeholders.stdout.txt",
        );
}
...
fn fmt_plain_and_hex_placeholders_should_follow_argument_order_bug() {
    ProjectBuilder::new("t-lib-api-fmt-placeholder-order-bug")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_fmt_env_tests/fmt_plain_and_hex_placeholders_should_follow_argument_order_bug.stdout.txt",
        );
}
...
fn fmt_fallback_for_non_int_specs_and_ignores_extra_args() {
    ProjectBuilder::new("t-lib-api-fmt-fallback-and-extra-args")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_fmt_env_tests/fmt_fallback_for_non_int_specs_and_ignores_extra_args.stdout.txt",
        );
}
...
fn env_bool_parsing_handles_case_numeric_falsey_and_missing() {
    ProjectBuilder::new("t-lib-api-env-bool-edge-cases")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_fmt_env_tests/env_bool_parsing_handles_case_numeric_falsey_and_missing.stdout.txt",
        );
}
...
fn env_or_uses_defaults_for_invalid_int_address_and_cell_values() {
    ProjectBuilder::new("t-lib-api-env-or-invalid-fallbacks")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_fmt_env_tests/env_or_uses_defaults_for_invalid_int_address_and_cell_values.stdout.txt",
        );
}
...
fn env_rejects_unsupported_target_types_with_clear_error() {
    ProjectBuilder::new("t-lib-api-env-unsupported-type")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_fmt_env_tests/env_rejects_unsupported_target_types_with_clear_error.stdout.txt",
        );
}
