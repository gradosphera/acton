...
fn save_test_trace_without_path_uses_default_directory() {
    ...
    output
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/cmd_agent_h_tests/save_test_trace_without_path_uses_default_directory.stdout.txt",
        )
        ...
        .assert_file_snapshot_matches(
            ...
            "integration/snapshots/test-runner/cmd_agent_h_tests/save_test_trace_without_path_uses_default_directory.contract.txt",
        );
...
fn save_test_trace_with_custom_directory_uses_regular_non_ui_flow() {
    ...
    output
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/cmd_agent_h_tests/save_test_trace_with_custom_directory_uses_regular_non_ui_flow.stdout.txt",
        )
...
fn save_test_trace_creates_trace_per_test_and_single_contract_file() {
    ...
    output
        .assert_passed(2)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/cmd_agent_h_tests/save_test_trace_creates_trace_per_test_and_single_contract_file.stdout.txt",
        )
...
fn regular_run_without_trace_flag_does_not_create_trace_artifacts() {
    ...
    output
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/cmd_agent_h_tests/regular_run_without_trace_flag_does_not_create_trace_artifacts.stdout.txt",
        );
...
fn save_test_trace_can_be_enabled_after_regular_run() {
    ...
    regular_output
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/cmd_agent_h_tests/save_test_trace_can_be_enabled_after_regular_run.regular.stdout.txt",
        );
    ...
    traced_output
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/cmd_agent_h_tests/save_test_trace_can_be_enabled_after_regular_run.trace.stdout.txt",
        )
