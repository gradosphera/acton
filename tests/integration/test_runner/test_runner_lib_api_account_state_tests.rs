...
fn top_up_materializes_account_and_increases_balance() {
    run_account_state_case(
        ...
        "#,
        "integration/snapshots/test-runner/lib_api_account_state_tests/top_up_materializes_account_and_increases_balance.stdout.txt",
    );
}
...
fn set_shard_account_null_resets_state_and_balance() {
    run_account_state_case(
        ...
        "#,
        "integration/snapshots/test-runner/lib_api_account_state_tests/set_shard_account_null_resets_state_and_balance.stdout.txt",
    );
}
...
fn set_account_preserves_shard_markers_for_existing_address() {
    run_account_state_case(
        ...
        "#,
        "integration/snapshots/test-runner/lib_api_account_state_tests/set_account_preserves_shard_markers_for_existing_address.stdout.txt",
    );
}
...
fn set_shard_account_copies_state_between_addresses() {
    run_account_state_case(
        ...
        "#,
        "integration/snapshots/test-runner/lib_api_account_state_tests/set_shard_account_copies_state_between_addresses.stdout.txt",
    );
}
...
fn get_account_state_for_fresh_address_is_null_before_top_up() {
    run_account_state_case(
        ...
        "#,
        "integration/snapshots/test-runner/lib_api_account_state_tests/get_account_state_for_fresh_address_is_null_before_top_up.stdout.txt",
    );
}
