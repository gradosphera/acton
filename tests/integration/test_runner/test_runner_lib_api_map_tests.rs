...
fn map_contains_and_absence_matchers_pass_for_contract_side_map() {
    ...
    .assert_snapshot_matches(
        "integration/snapshots/test-runner/lib_api_map_tests/map_contains_and_absence_matchers_pass_for_contract_side_map.stdout.txt",
    );
}
...
fn map_empty_matchers_pass_for_empty_contract_side_map() {
    ...
    .assert_passed(1)
    .assert_snapshot_matches(
        "integration/snapshots/test-runner/lib_api_map_tests/map_empty_matchers_pass_for_empty_contract_side_map.stdout.txt",
    );
}
...
fn map_have_length_counts_unique_keys_after_overwrite() {
    ...
    .assert_passed(1)
    .assert_snapshot_matches(
        "integration/snapshots/test-runner/lib_api_map_tests/map_have_length_counts_unique_keys_after_overwrite.stdout.txt",
    );
}
...
fn map_to_contain_key_failure_reports_missing_key() {
    ...
    .assert_failed(1)
    .assert_snapshot_matches(
        "integration/snapshots/test-runner/lib_api_map_tests/map_to_contain_key_failure_reports_missing_key.stdout.txt",
    );
}
...
fn map_to_not_contain_value_failure_reports_present_value() {
    ...
    .assert_failed(1)
    .assert_snapshot_matches(
        "integration/snapshots/test-runner/lib_api_map_tests/map_to_not_contain_value_failure_reports_present_value.stdout.txt",
    );
}
