...
fn comparison_matchers_pass() {
    ProjectBuilder::new("lib-api-comparison-pass")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_matchers_tests/comparison_matchers_pass.stdout.txt",
        );
}
...
fn comparison_matchers_fail() {
    ProjectBuilder::new("lib-api-comparison-fail")
        ...
        .assert_failed(4)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_matchers_tests/comparison_matchers_fail.stdout.txt",
        );
}
...
fn approx_matchers_pass() {
    ProjectBuilder::new("lib-api-approx-pass")
        ...
        .assert_passed(4)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_matchers_tests/approx_matchers_pass.stdout.txt",
        );
}
...
fn approx_matchers_fail() {
    ProjectBuilder::new("lib-api-approx-fail")
        ...
        .assert_failed(3)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_matchers_tests/approx_matchers_fail.stdout.txt",
        );
}
