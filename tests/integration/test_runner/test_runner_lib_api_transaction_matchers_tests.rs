...
fn to_have_and_not_have_tx_by_action_exit_code() {
    ...
    ProjectBuilder::new("p-lib-api-action-exit-code")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_transaction_matchers_tests/lib_api_to_have_and_not_have_tx_by_action_exit_code.stdout.txt",
        );
}
...
fn to_have_and_not_have_tx_by_compute_phase_skipped() {
    ...
    ProjectBuilder::new("p-lib-api-compute-phase-skipped")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_transaction_matchers_tests/lib_api_to_have_and_not_have_tx_by_compute_phase_skipped.stdout.txt",
        );
}
...
fn to_have_and_not_have_tx_by_body() {
    ...
    ProjectBuilder::new("p-lib-api-body")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_transaction_matchers_tests/lib_api_to_have_and_not_have_tx_by_body.stdout.txt",
        );
}
...
fn to_have_and_not_have_tx_by_opcode() {
    ...
    ProjectBuilder::new("p-lib-api-opcode")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_transaction_matchers_tests/lib_api_to_have_and_not_have_tx_by_opcode.stdout.txt",
        );
}
...
fn find_transaction_by_explicit_opcode_without_generic() {
    ...
    ProjectBuilder::new("p-lib-api-find-transaction-opcode")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_transaction_matchers_tests/lib_api_find_transaction_by_explicit_opcode_without_generic.stdout.txt",
        );
}
...
fn to_have_tx_with_bounced_opcode_prefix() {
    ...
    ProjectBuilder::new("p-lib-api-bounced-opcode")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_transaction_matchers_tests/lib_api_to_have_tx_with_bounced_opcode_prefix.stdout.txt",
        );
}
