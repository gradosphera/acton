...
fn run_fixture_success_case(test_file: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn get_account_state_after_top_up_returns_account_info_with_expected_balance() {
    run_project_case(
...
#[test]
fn get_account_state_transitions_from_null_to_non_null_after_top_up() {
