...
fn register_code_cell_labels_auto_deploy_transactions() {
    ProjectBuilder::new("lib-api-register-code-cell-label")
        ...
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_register_code_cell_tests/register_code_cell_labels_auto_deploy_transactions.stdout.txt",
        );
}
...
fn register_code_cell_last_registration_wins_for_same_hash() {
    ProjectBuilder::new("lib-api-register-code-cell-last-wins")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_register_code_cell_tests/register_code_cell_last_registration_wins_for_same_hash.stdout.txt",
        );
}
...
fn register_code_cell_does_not_rename_other_contract_hashes() {
    ProjectBuilder::new("lib-api-register-code-cell-is-hash-specific")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_register_code_cell_tests/register_code_cell_does_not_rename_other_contract_hashes.stdout.txt",
        );
}
...
fn register_address_name_has_priority_over_registered_code_name() {
    ProjectBuilder::new("lib-api-register-address-over-code-name")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_register_code_cell_tests/register_address_name_has_priority_over_registered_code_name.stdout.txt",
        );
}
...
fn register_code_cell_from_get_deployed_code_applies_to_future_transactions() {
    ProjectBuilder::new("lib-api-register-code-cell-from-deployed-code")
        ...
        .assert_passed(1)
        .assert_snapshot_matches(
            "integration/snapshots/test-runner/lib_api_register_code_cell_tests/register_code_cell_from_get_deployed_code_applies_to_future_transactions.stdout.txt",
        );
}
