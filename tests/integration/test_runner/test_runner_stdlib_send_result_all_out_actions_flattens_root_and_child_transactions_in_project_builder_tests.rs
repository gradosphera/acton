...
fn run_project_builder_success(project_name: &str, test_body: &str, snapshot_path: &str) {
...
#[test]
fn send_result_all_out_actions_flattens_root_and_child_transactions_in_project_builder() {
...
#[test]
fn send_result_all_out_actions_terminal_transaction_without_actions_in_fixture_project() {
