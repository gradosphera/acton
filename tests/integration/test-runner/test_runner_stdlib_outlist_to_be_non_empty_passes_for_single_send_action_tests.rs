...
#[test]
fn outlist_to_be_non_empty_passes_for_single_send_action() {
    run_outlist_success(
...
#[test]
fn outlist_to_be_send_message_at_extracts_typed_body() {
    run_outlist_success(
...
#[test]
fn outlist_to_be_send_message_at_opcode_mismatch_reports_known_type() {
    run_outlist_failure(
...
#[test]
fn outlist_to_be_send_message_at_opcode_mismatch_without_known_type_name() {
    run_outlist_success(
...
#[test]
fn outlist_to_be_send_message_at_bounced_prefix_opcode_mismatch_is_reported() {
    run_outlist_success(
