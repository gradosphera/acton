...
fn test_new_counter_app_template_wrappers_match_autogenerated() {
    ...
    let template_wrapper = fs::read_to_string(project_dir.join("contracts/wrappers/Counter.tolk"))
    ...
    assert_eq!(
        template_wrapper, generated_wrapper,
        "Template wrapper `contracts/wrappers/Counter.tolk` does not match auto-generated wrapper for contract `Counter`"
    );
}
...
fn test_new_jetton_template_wrappers_match_autogenerated() {
    create_project_and_check_wrappers(
        ...
        "jetton",
        &[
            ("JettonMinter", "wrappers/JettonMinter.tolk"),
            ("JettonWallet", "wrappers/JettonWallet.tolk"),
        ],
    );
}
