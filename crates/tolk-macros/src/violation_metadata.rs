...
pub(crate) fn violation_metadata(input: DeriveInput) -> syn::Result<TokenStream> {
    ...
    Ok(quote! {
        ...
        #[expect(deprecated)]
        impl #impl_generics crate::rules::violation::ViolationMetadata for #name #ty_generics #where_clause {
            fn rule() -> crate::rules::violation::Rule {
                crate::rules::violation::Rule::#name
            }
