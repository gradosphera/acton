...
- Why custom matchers are better than standalone check functions
- How to create a custom matcher for any type
- How to use the `Assert` library inside a matcher to create descriptive error messages
