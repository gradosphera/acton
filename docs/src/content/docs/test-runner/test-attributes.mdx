...
**What you'll learn:**
- How to use the `@custom` annotation syntax
- Available test attributes and their effects
- How to skip tests temporarily
- How to mark tests as TODO
- How to set expected exit codes
- How to set gas limits for tests
