...
In this tutorial, we'll build integration tests for a simple Counter smart contract in Tolk. Integration tests differ from unit tests they test real message sending between contracts, not just isolated functions like in unit tests.
