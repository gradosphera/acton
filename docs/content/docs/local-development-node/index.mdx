...
Acton includes a built-in local development node available through `acton litenode`.
...
<Cards>
  <Card href="/docs/local-development-node/getting-started" title="Getting Started">
    Start the node, send your first airdrop, and verify that the API is available.
  </Card>
  <Card href="/docs/local-development-node/forking-from-network" title="Forking from Network">
    Use testnet or mainnet state locally, including historical forks at a specific block.
  </Card>
  <Card href="/docs/local-development-node/startup-accounts" title="Startup Accounts">
    Auto-fund and auto-deploy configured wallets on node startup.
  </Card>
  <Card href="/docs/local-development-node/persistence-and-snapshots" title="Persistence and Snapshots">
    Persist state to SQLite or export/import JSON snapshots for repeatable runs.
  </Card>
  <Card href="/docs/local-development-node/api-compatibility" title="API Compatibility">
