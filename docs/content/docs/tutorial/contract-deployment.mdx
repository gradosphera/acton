...
See the [Setting up wallets](/docs/tutorial/setup-wallets/) guide for detailed instructions on configuring wallets safely.
...
<Callout type="warning">
  Before deploying, make sure you have launched the [localnet](/docs/localnet/overview).
</Callout>
