...
<Files>
  <Folder name="app" description="dApp project root (package.json, vite.config.ts)" defaultOpen>
    <Folder name="app" description="Vite source root" defaultOpen>
      <Folder name="src" defaultOpen>
        <File name="App.tsx" />
        <Folder name="lib" description="ton.ts, router.ts, utils.ts" />
        <File name="..." />
      </Folder>
    </Folder>
    <Folder name="wrappers-ts" description="placeholder, will be replaced" />
  </Folder>
</Files>
