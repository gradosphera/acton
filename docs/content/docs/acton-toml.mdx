...
| `coverage-include-wrappers` | `boolean`  | `false`       | Include files from the `@wrappers` mapping in coverage reports.        |
| `coverage-include-tests`    | `boolean`  | `false`       | Include `.test.tolk` files in coverage reports.                        |
