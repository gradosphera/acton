...
The `[test.mutation]` subsection allows filtering mutation runs by level and
disabling specific mutation rules.
Available rule IDs are documented in [Mutation Rules](/docs/test-runner/mutation-testing/rules).
