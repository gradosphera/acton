...
| `explorer` | `string` | No       | Base URL for transaction links in this network. If omitted, links are derived from `api.v2`. |

Example:
```toml
[networks.my-custom-net]
api = { v2 = "https://my-custom-net.com/api/v2", v3 = "https://my-custom-net.com/api/v3" }
explorer = "https://my-custom-net.com/explorer/tx"
```
