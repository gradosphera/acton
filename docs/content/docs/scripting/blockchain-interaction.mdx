...
Before interacting with the real blockchain, you need to configure a wallet in your `Acton.toml`. Follow the [Setting up wallets](/docs/scripting/setup-wallets/) guide to configure your wallet with mnemonic and expected addresses.
