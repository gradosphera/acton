...
Before interacting with the real blockchain, you need to configure a wallet in your `wallets.toml` (or global configuration). Follow the [Setting up wallets](/docs/setup-wallets/) guide to configure your wallet with a mnemonic.
...
**Behavior:**
- Without `--net`: Creates a local test wallet (similar to `net.treasury()`)
...
- Learn more about [wallet configuration](/docs/setup-wallets/)
