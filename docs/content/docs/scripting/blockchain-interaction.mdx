...
Before interacting with the real blockchain, you need to configure a wallet in your `wallets.toml` (or global configuration). Follow the [Setting up wallets](/docs/tutorial/setup-wallets) guide to configure your wallet with a mnemonic.
...
- Learn more about [wallet configuration](/docs/tutorial/setup-wallets)
