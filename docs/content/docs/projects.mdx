...
import {
  ...
  AnnotatedFiles,
  AnnotatedFolder,
} from "@/components/AnnotatedFiles";
...
For coding-agent workflows, the `acton` skill covers CLI commands and `Acton.toml` configuration, and the `tolk` skill covers writing and reviewing Tolk contracts. See the [agent skills](/docs/agent-skills) guide for installation and usage.
...
<AnnotatedFiles>
  <AnnotatedFolder name="acton-project" defaultOpen>
    <AnnotatedFile name="Acton.toml" description="Project manifest — edit directly" />
    <AnnotatedFile name=".env" description="Local secrets — not committed" />
    <AnnotatedFolder
      name=".acton"
      description="Acton-managed internal state and Tolk libraries"
    >
      <AnnotatedFolder name="tolk-stdlib" description="Bundled Tolk standard library" />
    </AnnotatedFolder>
    <AnnotatedFolder name="contracts" description="Tolk source files" defaultOpen>
      <AnnotatedFile name="Contract.tolk" description="Contract entry point" />
    </AnnotatedFolder>
    <AnnotatedFolder
      name="wrappers"
      description="Generated Tolk wrappers (.gen.tolk)"
      defaultOpen
    >
      <AnnotatedFile name="Contract.gen.tolk" description="Generated contract wrapper" />
    </AnnotatedFolder>
    <AnnotatedFolder name="tests" description="Test files (.test.tolk)" defaultOpen>
      <AnnotatedFile name="contract.test.tolk" description="Contract tests" />
    </AnnotatedFolder>
    <AnnotatedFolder
      name="scripts"
      description="Deployment and utility Tolk scripts"
      defaultOpen
    >
      <AnnotatedFile name="deploy.tolk" description="Deployment script" />
    </AnnotatedFolder>
    <AnnotatedFolder name="build" description="Compiled output (.boc, .fif)">
      <AnnotatedFile name="Contract.boc" description="Compiled contract BoC" />
      <AnnotatedFile name="Contract.fif" description="Optional Fift output" />
    </AnnotatedFolder>
    <AnnotatedFolder
      name="gen"
      description="Generated dependency helpers (.code.tolk)"
    >
      <AnnotatedFile name="Contract.code.tolk" description="Compiled dependency helper" />
    </AnnotatedFolder>
  </AnnotatedFolder>
</AnnotatedFiles>
...
<AnnotatedFiles>
  <AnnotatedFolder name="acton-project" defaultOpen>
    <AnnotatedFile name="Acton.toml" description="Project manifest" />
    <AnnotatedFile name=".env" description="Local secrets — not committed" />
    <AnnotatedFolder
      name=".acton"
      description="Acton-managed internal state and Tolk libraries"
    ...
    <AnnotatedFolder name="app" description="React + Vite frontend" defaultOpen>
      <AnnotatedFolder name="src" description="Frontend source files" />
    </AnnotatedFolder>
    <AnnotatedFolder
      name="wrappers-ts"
      description="Generated TypeScript wrappers"
      defaultOpen
    >
      <AnnotatedFile name="Contract.gen.ts" description="Generated TypeScript wrapper" />
    </AnnotatedFolder>
    <AnnotatedFolder name="contracts" description="Tolk workspace" defaultOpen>
      <AnnotatedFolder name="src" description="Tolk source files" defaultOpen>
        <AnnotatedFile name="Contract.tolk" description="Contract entry point" />
      </AnnotatedFolder>
      <AnnotatedFolder
        name="wrappers"
        description="Generated Tolk wrappers"
        defaultOpen
      >
        <AnnotatedFile name="Contract.gen.tolk" description="Generated contract wrapper" />
      </AnnotatedFolder>
      <AnnotatedFolder name="tests" description="Test files" defaultOpen>
        <AnnotatedFile name="contract.test.tolk" description="Contract tests" />
      </AnnotatedFolder>
      <AnnotatedFolder
        name="scripts"
    ...
    <AnnotatedFolder name="build" description="Compiled output">
      <AnnotatedFile name="Contract.boc" description="Compiled contract BoC" />
      <AnnotatedFile name="Contract.fif" description="Optional Fift output" />
    </AnnotatedFolder>
    <AnnotatedFolder name="gen" description="Generated dependency helpers">
      <AnnotatedFile name="Contract.code.tolk" description="Compiled dependency helper" />
    </AnnotatedFolder>
  </AnnotatedFolder>
</AnnotatedFiles>
