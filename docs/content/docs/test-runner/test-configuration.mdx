...
| `coverage-format`           | `--coverage-format`           | String  | Coverage output format ("lcov")                                |
| `coverage-include-wrappers` | `--coverage-include-wrappers` | Boolean | Include files from the `@wrappers` mapping in coverage reports |
| `coverage-include-tests`    | `--coverage-include-tests`    | Boolean | Include `.test.tolk` files in coverage reports                 |
