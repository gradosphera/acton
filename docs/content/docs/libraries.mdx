...
acton library publish Math --duration 100d --amount 0.2 --wallet my-wallet --net mainnet --yes --local
```
...
When the balance is low, top up with `acton library topup`. Pass either a duration or a TON amount:
